...
class User(AbstractUser):
    ...
    image           = models.ImageField(upload_to='./static', default= "./static/auction/default.jpg", null=True, editable=True)
...
class Item(models.Model):
    ...
    image = models.ImageField(upload_to='./static', default="./static/auction/default_item.jpg", null=True, editable=True)
    image_name = models.CharField(max_length=30, null=True, editable=True)
