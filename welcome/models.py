...
class Question(models.Model):
    ...
    owner = models.ForeignKey('welcome.User',related_name='owner_set_question', null=True, on_delete=models.CASCADE)
    user = models.ForeignKey('welcome.User', related_name='user_set',null=True, on_delete=models.CASCADE)
    item = models.ForeignKey('welcome.Item', related_name='item_set',null=True, on_delete=models.CASCADE)
