...
class User(AbstractUser):
    ...
    image           = models.ImageField(upload_to='./welcome/static', default= "./welcome/static/default.jpg", null=True, editable=True)
...
class Item(models.Model):
    ...
    owner = models.ForeignKey('welcome.User', related_name='owner_set_item' ,on_delete=models.CASCADE)
...
class Question(models.Model):
    ...
    owner = models.ForeignKey('welcome.User',related_name='owner_set_question', on_delete=models.CASCADE)
    user = models.ForeignKey('welcome.User', related_name='user_set', on_delete=models.CASCADE)
    item = models.ForeignKey('welcome.Item', related_name='item_set', on_delete=models.CASCADE)
